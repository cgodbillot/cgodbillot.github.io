...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "publications",
          description: "I have had the pleasure of participating in a variety of studies over the years, presented below in their published form.",
          section: "Navigation",
          handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-our-paper-on-the-use-of-cnns-for-diatom-detection-has-been-published-find-out-all-the-details-on-related-research-here",
          title: 'Our paper on the use of CNNs for diatom detection has been published!...',
          description: "",
